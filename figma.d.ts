...
declare global {
  ...
  interface PluginAPI {
    ...
    on(
      type: "selectionchange" | "currentpagechange" | "close" | "run",
  ...
  interface SuggestionExtended {
    name: string;
    data?: any;
    icon?: string | Uint8Array;
  }

  type Suggestion = string | SuggestionExtended;
  ...
  interface ParametersAPI {
    on(
      type: "input" | "suggestionchange",
      callback: ParameterChangeHandler | SelectionChangeHandler
    ): void;
    once(
      type: "input" | "suggestionchange",
      callback: ParameterChangeHandler | SelectionChangeHandler
